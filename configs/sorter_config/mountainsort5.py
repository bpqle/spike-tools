# The following file is a customized reordering of parameter inputs for mountainsort5.
# The original parameter naming and inputting was not in accordance with the sorter's own defined parameters.
# Drop this in the installed package spikeinterface/sorters/external/
...
class Mountainsort5Sorter(BaseSorter):
    ...
    _default_params = {
        ...
        "scheme2_phase2_detect_threshold": 5.5,
        "scheme2_phase2_detect_channel_radius": 80,
        "scheme2_phase2_detect_time_radius_msec": 50,
    ...
    _params_description = {
        ...
        "detect_threshold": "Scheme1 / Scheme2Phase1 Detection threshold",
        "detect_time_radius_msec": "Scheme1 / Scheme2Phase1 Determines the minimum allowable time interval between detected spikes in the same spatial region",
        "detect_channel_radius": "Scheme1 / Scheme2Phase1 Channel radius for excluding events that are too close in time in scheme 1",
        "scheme2_phase2_detect_threshold": "Scheme2Phase2 Detection threshold",
        "scheme2_phase2_detect_channel_radius": " Scheme2Phase2 Channel radius for excluding events that are too close in time in scheme 1",
        "scheme2_phase2_detect_time_radius_msec": "Scheme2Phase2 Determines the minimum allowable time interval between detected spikes in the same spatial region",
    ...
    def _run_from_folder(cls, sorter_output_folder, params, verbose):
        ...
        scheme1_sorting_parameters = ms5.Scheme1SortingParameters(
            ...
            detect_channel_radius=p["detect_channel_radius"],
        ...
        scheme2_sorting_parameters = ms5.Scheme2SortingParameters(
            phase1_detect_channel_radius=p["detect_channel_radius"],
            detect_channel_radius=p["scheme2_phase2_detect_channel_radius"],
            phase1_detect_threshold=p["detect_threshold"],
            phase1_detect_time_radius_msec=p["detect_time_radius_msec"],
            detect_time_radius_msec=p["scheme2_phase2_detect_time_radius_msec"],
            phase1_npca_per_channel=p["npca_per_channel"],
            phase1_npca_per_subdivision=p["npca_per_subdivision"],
            detect_sign=p["detect_sign"],
            detect_threshold=p["scheme2_phase2_detect_threshold"],
            snippet_T1=p["snippet_T1"],
            snippet_T2=p["snippet_T2"],
            snippet_mask_radius=p["snippet_mask_radius"],
